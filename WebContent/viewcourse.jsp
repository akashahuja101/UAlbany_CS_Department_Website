...
<%
	ArrayList<courseModel> viewcourse = (ArrayList<courseModel>) request.getAttribute("course");
%>
	...
	<div id="page-content-wrapper">
		...
		<div class="col-md-5">
			<table style="font-size: 20px; text-align: center"
				...
				<tr>
					<th style="text-align: center; font-size: 23px">Course No</th>
					<th style="text-align: center; font-size: 23px">Course Name</th>
					<th style="text-align: center; font-size: 23px">Add Course</th>
				</tr>
				...
				<tr>
					<td>
						<%
							out.println(viewcourse.get(i).getCourse_id());
						%>
					</td>
					<td>
						<%
							out.println(viewcourse.get(i).getCourse_name());
						%>
					</td>

					<td><form
							action="SelectCourseServlet?id=<%=viewcourse.get(i).getCourse_id()%>&amp;name=<%=viewcourse.get(i).getCourse_name()%>"
							method="post">
							<button type="submit" id="submit" class="btn btn-default">Teach
								This Course</button>
						</form></td>
				</tr>
				<%
