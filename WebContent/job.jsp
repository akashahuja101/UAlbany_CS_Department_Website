...
<%@include file="header.jsp"%>
	...
	<div class="col-md-4">
		...
		<div class="form-bottom">
			<form role="form" action="InsertJobServlet" method="post"
				...
				<div style="text-align: justify; font-size: 20px" class="form-group">
					...
					<label style="color: black" class="" for="name">Enter
						Job Description:</label><input type="text" name="job" placeholder="Job..."
				...
				<div style="text-align: justify; font-size: 20px" class="form-group">
					...
					<label style="color: black" class="" for="link">Enter
						Job Link:</label><input type="text" name="link" placeholder="link..."
