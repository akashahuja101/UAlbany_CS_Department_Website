...
<div id="wrapper">
	...
	<div class="col-md-4">
		...
		<div class="form-bottom">
			<form role="form" action="EditEventServlet?content=<%=content%>" method="post"
				...
				<div style="text-align: justify; font-size: 20px" class="form-group">
					...
					<label style="color: black" class="" for="name">Enter new
						Event:</label><input type="text" name="event" value="<%=content%>"
