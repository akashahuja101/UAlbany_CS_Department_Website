...
<div id="wrapper">
	...
	<div class="col-md-4">
		...
		<h1 style="color: black; text-align: justify">Events</h1>
		<br>
		<div class="form-bottom">
			<form role="form" action="EventServlet" method="post"
				...
				<div style="text-align: justify; font-size: 20px" class="form-group">
					...
					<label style="color: black" class="" for="name">Enter
						Event:</label><input type="text" name="event" placeholder="Event..."
						class="form-first-name form-control" id="event" required>
				...
				<div style="text-align: justify; font-size: 20px" class="form-group">
					...
					%>
					<a href="editEvent.jsp?content=<%=rs.getString(2)%>">Edit</a>&nbsp&nbsp<a
						href="DeleteEventServlet?content=<%=rs.getString(2)%>">Delete</a>
					<%
						}
					%>
