...
<%
	...
	rs = ad.getRegisteredStudent(name);
	String id = null;
%>
...
<div id="wrapper">
	...
	<div class="col-md-4">
		...
		<div class="form-bottom">
			...
			<form role="form"
				action="InsertResultServlet?name=<%=name%>"
				method="post" class="registration-form center_div">



				<div style="text-align: justify; font-size: 20px" class="form-group">
					<label style="color: black" class="" for="stu">Select
						Student</label><br> <select class="form-control" name="stu" id="stu"
						onChange="showfield();">
						<%
							while (rs.next()) {
						%>
